...
const translations = {
  es: {
    ...
    version: 'Versión',
    credits: 'Créditos',
    creditsContent: 'Sus_App es una aplicación neobrutalista premium diseñada para gestionar tus suscripciones sin esfuerzo. Desarrollada con React, TypeScript y Tailwind CSS.',
  ...
  en: {
    ...
    version: 'Version',
    credits: 'Credits',
    creditsContent: 'Sus_App is a premium neobrutalist application designed to manage your subscriptions effortlessly. Built with React, TypeScript, and Tailwind CSS.',
